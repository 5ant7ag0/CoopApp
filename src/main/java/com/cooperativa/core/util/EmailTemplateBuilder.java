...
public class EmailTemplateBuilder {
     ...
     */
    public String buildCorporateEmail(String titulo, String mensaje, String cuerpo, String notaPie, String coopName) {
        String name = (coopName != null && !coopName.trim().isEmpty()) ? coopName.toUpperCase() : "COOPERATIVA DE AHORRO Y CRÉDITO";
        return String.format(
            ...
            "<div class=\"footer\">Este es un mensaje automático de la %s. Por favor no responda a este correo.</div>" +
            "</div></body></html>",
            name, titulo, mensaje, cuerpo, notaPie, name
        );
    }

    /**
     * Construye la plantilla HTML del SAAS MANAGER inyectando el contenido dinámico.
     */
    public String buildSaaSEmail(String titulo, String mensaje, String cuerpo, String notaPie) {
        return String.format(
            "<!DOCTYPE html><html><head><style>" +
            "body { font-family: Arial, sans-serif; background-color: #f8fafc; color: #1e293b; padding: 20px; }" +
            ".card { max-width: 500px; margin: 0 auto; background: white; border-radius: 16px; padding: 30px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); }" +
            ...
            ".footer { text-align: center; font-size: 11px; color: #94a3b8; margin-top: 30px; border-top: 1px solid #f1f5f9; padding-top: 15px; }" +
            "</style></head><body><div class=\"card\">" +
            "<div class=\"header\"><div class=\"logo\">SAAS MANAGER</div></div>" +
            "<div class=\"title\">%s</div>" +
            "<p>%s</p>" +
            "<div class=\"content-block\">%s</div>" +
            "<p style=\"font-size: 12px; color: #64748b;\">%s</p>" +
            "<div class=\"footer\">Este es un mensaje automático de la plataforma SAAS MANAGER. Por favor no responda a este correo.</div>" +
            "</div></body></html>",
